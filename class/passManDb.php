...
class passManDb
{
	 ...
	 * @throws Exception
	 */
	public function fetchAll($array_of_fields, $table_element, $filter = '', $filter_mode = 'AND', $sortfield = '', $sortorder = '', $group = '', $limit = 0, $offset = 0,
							 $hasParent = '', $parentClassTable = '', $parentClassFields = '', $childClassField = '')
	{
	 ...
	 * @throws Exception
	 */
	public function fetch($id = '', $array_of_fields, $table_element, $filter = '', $filter_mode = 'AND', $sortfield = '', $sortorder = '', $group = '', $limit = 0, $offset = 0,
						  $hasParent = '', $parentClassTable = '', $parentClassFields = '', $childClassField = '')
	{
